...
public class InMemoryTimeEntryRepositoryTest {
  ...
  public void update() {
    ...
    TimeEntry updatedEntry =
        repo.update(
            created.getId(), new TimeEntry(0, 321L, 654L, LocalDate.parse("2017-01-09"), 5));
  ...
  public void update_MissingEntry() {
    ...
    TimeEntry updatedEntry =
        repo.update(1L, new TimeEntry(0, 321L, 654L, LocalDate.parse("2017-01-09"), 5));
