...
public class TimeEntryControllerTest {
  ...
  public void testCreate() {
    ...
    TimeEntry timeEntryToCreate =
        new TimeEntry(0, projectId, userId, LocalDate.parse("2017-01-08"), 8);

    long timeEntryId = 1L;
    TimeEntry expectedResult =
  ...
  public void testUpdate() {
    ...
    TimeEntry timeEntryToUpdate =
        new TimeEntry(0, projectId, userId, LocalDate.parse("2017-01-07"), 4);

    TimeEntry expected =
        new TimeEntry(timeEntryId, projectId, userId, LocalDate.parse("2017-01-07"), 4);
  ...
  public void testUpdate_NotFound() {
    ...
    ResponseEntity<TimeEntry> response =
        controller.update(nonExistentTimeEntryId, new TimeEntry(0, 0, 0, LocalDate.EPOCH, 0));
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
  }
